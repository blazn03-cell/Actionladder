...
export function registerHallRoutes(app: Express) {
  ...
  app.get("/api/halls/:hallId", async (req, res) => {
    try {
  ...
  app.post("/api/hall-matches", async (req, res) => {
    try {
  ...
  app.patch("/api/hall-matches/:matchId", async (req, res) => {
    try {
  ...
  // Get hall roster
  app.get("/api/halls/:hallId/roster", async (req, res) => {
    try {
      const { hallId } = req.params;
      const roster = await storage.getRosterByHall(hallId);
  ...
  app.post("/api/halls/:hallId/roster", async (req, res) => {
    try {
      const { hallId } = req.params;
  ...
  app.delete("/api/halls/:hallId/roster/:rosterId", async (req, res) => {
    try {
  ...
  app.get("/api/halls/:hallId/stats", async (req, res) => {
    try {
      const { hallId } = req.params;
      const hall = await storage.getPoolHall(hallId);
