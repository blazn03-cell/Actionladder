          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="Local Youth Center Support" data-testid="input-charity-name" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea 
                      {...field} 
                      placeholder="Tournament proceeds benefit Seguin Youth Programs"
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-300">Fundraising Goal ($)</FormLabel>
                    <FormControl>
                      <Input 
                        type="number" 
                        {...field} 
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-300">Pot Percentage</FormLabel>
                    <FormControl>
                      <Input 
                        type="number" 
                        step="0.01"
            ...
            <div className="flex justify-end space-x-2">
              ...
              >
                {createCharityEventMutation.isPending ? (
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="bg-black/40 rounded-lg p-3">
            <div className="text-xs text-gray-400 mb-1">Pot Contribution</div>
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-start space-x-2">
            ...
            <span className="text-gray-300">
              <span className="text-white font-semibold">Auto-Donation:</span> Percentage of tournament pots automatically contributed
            </span>
          </div>
          <div className="flex items-start space-x-2">
            <span className="text-pink-400 font-bold">•</span>
            <span className="text-gray-300">
              <span className="text-white font-semibold">House Matching:</span> Tri-City Ladder matches community donations dollar-for-dollar
            </span>
          </div>
          <div className="flex items-start space-x-2">
            <span className="text-pink-400 font-bold">•</span>
