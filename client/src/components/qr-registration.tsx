...
function GenerateQRDialog() {
  ...
  const downloadQR = () => {
    ...
    link.download = 'action-ladder-registration-qr.png';
  ...
  const shareQR = () => {
    if (navigator.share) {
      navigator.share({
        title: 'Join Action Ladder Billiards',
          ...
          {!qrCodeData ? (
            ...
            <div className="space-y-4">
              <div className="text-center">
                <img src={qrCodeData} alt="Registration QR Code" className="mx-auto mb-4 rounded-lg border border-green-500/30" />
              ...
              <div className="bg-gray-900/50 border border-gray-600/30 rounded-lg p-4">
                ...
                <ul className="text-sm text-gray-300 space-y-1">
                  ...
                  <li>• They'll be taken to a mobile-friendly registration form</li>
                  <li>• New registrations appear instantly in your system</li>
                </ul>
              </div>
            </div>
          )}
  ...
  const registerMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "Welcome to Action Ladder Billiards! Your profile has been created.",
      });
      form.reset();
    },
    onError: (error: any) => {
            ...
            {recentRegistrations.map((player) => (
              <div key={player.id} className="flex items-center justify-between p-3 bg-gray-900/30 rounded-lg">
                <div>
                  ...
                  <div className="text-sm text-gray-400">{player.city} • Rating: {player.rating}</div>
                  {player.theme && (
                    <div className="text-xs text-gray-500 italic">"{player.theme}"</div>
                  )}
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Mobile-friendly form, instant ladder entry</p>
                </div>
              </div>
            </div>
          </CardContent>
